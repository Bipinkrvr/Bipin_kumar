  ...
  return (
    ...
    <section id="projects" className="w-full h-[100dvh] min-h-[600px] snap-center flex flex-col justify-center relative pt-16 pb-4">
      ...
      <div className="w-full flex-grow flex flex-col relative z-10 min-h-0">
        ...
        {/* The Server Rack - 2-Column Grid to fit more items without scrolling */}
        <div className="flex-grow grid grid-cols-1 md:grid-cols-2 gap-2 bg-zinc-200 border-x-[8px] border-zinc-300 p-2 shadow-[inset_0_0_15px_rgba(0,0,0,0.05)] overflow-hidden">
          
          {projects.map((mod) => {
            const Icon = mod.icon;
            
            const colorMap = {
              emerald: { text: "text-emerald-600", border: "border-emerald-300", hover: "group-hover:text-emerald-600" },
              cyan: { text: "text-cyan-600", border: "border-cyan-300", hover: "group-hover:text-cyan-600" },
              amber: { text: "text-amber-600", border: "border-amber-300", hover: "group-hover:text-amber-600" },
              blue: { text: "text-blue-600", border: "border-blue-300", hover: "group-hover:text-blue-600" }
            };
              ...
              >
                ...
                <div className="hidden sm:flex items-center gap-1 bg-zinc-100 border-r border-zinc-200 px-1.5 py-2 shrink-0">
                  ...
                  <div className="grid grid-cols-1 gap-1 px-0.5">
                     {[...Array(5)].map((_, i) => (
                       <div key={i} className="w-1 h-1 rounded-full bg-zinc-300 shadow-inner"></div>
                     ))}
                  </div>
                </div>
